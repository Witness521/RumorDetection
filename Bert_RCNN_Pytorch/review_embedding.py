...
class Model(nn.Module):
    ...
    '''
    def review_embedding(self):
        # tokenizer
        inputs = self.tokenizer(self.review_list,
   ...
   '''
    def execute(self, dataset_len):
        ...
        review_emb = self.save_post_cls_list.get()
        # 当队列不为空的时候
        ...
        torch.save(review_emb, './dataSet/saved_tensor/review_embedding.pt')
